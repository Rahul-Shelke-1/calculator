...
* Head over to the [Installation Guide](getting_started/installation.md) to set up the package.
* Look at the [Quickstart](getting_started/quickstart.md) page to run your first calculation.
* Dive into the [API Reference](api/reference.md) to explore individual mathematical functions.
